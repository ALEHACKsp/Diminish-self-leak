...
bool Privs::RaiseAndGetHandle(LPCSTR priv, HANDLE* driverhandle) {
		...
		if (OpenThreadToken(GetCurrentThread(), TOKEN_ALL_ACCESS,
			...
			if (LookupPrivilegeValue(nullptr, priv,
				...
				if (AdjustTokenPrivileges(threadToken, FALSE, &privileges, 0,
					nullptr, nullptr)) {
					*driverhandle = CreateFileA("\\\\.\\EQProtection", GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ, 0, OPEN_EXISTING, 0, 0);
					PRIVILEGE_SET set;
